...
| 7   | Late_delivery_risk            | Whole Number   | Source Machine Learning training label replaced by **Late Delivery Risk** and **Is Late Delivery Risk** in `FactOrders`, both derived from `Lead Time Variance > 0` (actual vs. scheduled shipping days). See `[decision-log_v3.0.md](./decision-log_v3.0.md)` Entry #3. FactOrders column definitions below. |
...
Evaluated at **model refresh**. Folder in model: **Inventory Segmentation**. Full formulas and measure equivalents: `[dax-measures.md](./dax-measures.md)` - *DimProduct Calculated Columns*. See architectural decision entries: `[decision-log_v3.0.md](./decision-log_v3.0.md)`.
