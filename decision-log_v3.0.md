...
| `QA - Inventory lanning`      | APICS CPIM — safety stock, reorder point, and replenishment parameters, Safety stock, reorder point, reorder flag, stock coverage validated at product grain |
| `Financial Impact`            | `P&L Impact`                                                                                                                                                 |
