...
> This document maps every column in the Power BI model to its source, documents renames, derived columns, dropped columns, and data type decisions. It serves as the authoritative data dictionary for this project.
...
**Source:** Generated — not a reference to MasterSet
...
**PK:** Product Card Id
**Deduplication Key:** Product Card Id
...
**PK:** Order Id
**FK to DimDate:** Order Date
**FK to DimProduct:** Product Card Id
**FK to DimCustomer:** Customer Id
